    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth$2f$providers$2f$credentials__$5b$external$5d$__$28$next$2d$auth$2f$providers$2f$credentials$2c$__cjs$29$__["default"])({
            ...
            async authorize (credentials, req) {
                ...
                const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$service$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["signIn"])({
                    email,
                    password
                });
                if (user) {
                    const passwordConfirm = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["compare"])(password, user.password);
                    if (passwordConfirm) {
                        return user;
                    } else {
                        return null;
    ...
    callbacks: {
        async jwt ({ token, account, profile, user }) {
            ...
            if (account?.provider === "google") {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$service$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["signInWithGoogle"])(data, (result)=>{
                    if (result.status) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4f637cfc._.js.map